...
(function(n,f,l){function m(c,b,a){for(var e=0,g;g=c[e];e++){var d=f(g);d.is(b.selector)&&-1==b.firedElems.indexOf(d[0])&&(b.firedElems.push(d[0]),a.push({callback:b.callback,elem:d[0]}));0<g.childNodes.length&&m(g.childNodes,b,a)}}function p(c){for(var b=0,a;a=c[b];b++)a.callback(a.elem)}function k(c,b,a){var e=c[b];c[b]=function(){if(a.length==arguments.length)return a.apply(this,arguments);if("function"==typeof e)return e.apply(this,arguments)}}var q=function(){var c=function(){this._eventsBucket=
